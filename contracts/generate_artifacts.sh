...
cp ./l1-l2-messaging/cairo/target/dev/cairo_l1_l2.contract_class.json ../crates/starknet-devnet-cli/test_data/cairo1/messaging/cairo_1_l1l2.sierra
cp ./l1-l2-messaging/cairo/target/dev/cairo_l1_l2_lib.contract_class.json ../crates/starknet-devnet-cli/test_data/cairo1/messaging/cairo_1_l1l2_lib.sierra
