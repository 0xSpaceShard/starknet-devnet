...
pub const CAIRO_0_CONTRACT_PATH: &str =
    concat!(env!("CARGO_MANIFEST_DIR"), "/test_data/cairo0/cairo_0_test.casm");
// Example contract - Cairo 1
pub const CAIRO_1_CONTRACT_PATH: &str =
    concat!(env!("CARGO_MANIFEST_DIR"), "/test_data/cairo1/simple_storage/output.sierra");
