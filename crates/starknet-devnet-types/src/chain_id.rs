...
use starknet_rust::core::chain_id::{MAINNET, SEPOLIA};
use starknet_rust::core::utils::{cairo_short_string_to_felt, parse_cairo_short_string};
...
impl ChainId {
    /// Used only in tests.
    /// It was imported from `starknet_rust::core::chain_id`, but now gives a deprecation warning
