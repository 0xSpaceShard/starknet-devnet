...
mod tests {
    ...
    use crate::utils::test_utils::{dummy_broadcasted_declare_tx_v3, resource_bounds_with_price_1};
    ...
    fn get_sierra_class() {
        ...
        let mut declare_txn = dummy_broadcasted_declare_tx_v3(account.account_address);
