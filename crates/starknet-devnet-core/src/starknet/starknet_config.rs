...
impl Default for StarknetConfig {
    fn default() -> Self {
        ...
        StarknetConfig {
            ...
            start_time: None,
            l1_gas_price: DEVNET_DEFAULT_L1_GAS_PRICE.get().try_into().unwrap(),
            l1_data_gas_price: DEVNET_DEFAULT_L1_DATA_GAS_PRICE.get().try_into().unwrap(),
            l2_gas_price: DEVNET_DEFAULT_L2_GAS_PRICE.get().try_into().unwrap(),
