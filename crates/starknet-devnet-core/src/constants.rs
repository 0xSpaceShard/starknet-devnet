...
pub(crate) const RESOURCE_FEE_COST: [(&'static str, f64); 10] = [
    ...
    (RANGE_CHECK_BUILTIN_NAME, N_STEPS_FEE_WEIGHT * 16.0),
    (SIGNATURE_BUILTIN_NAME, N_STEPS_FEE_WEIGHT * 2048.0),
    (BITWISE_BUILTIN_NAME, N_STEPS_FEE_WEIGHT * 64.0),
    (EC_OP_BUILTIN_NAME, N_STEPS_FEE_WEIGHT * 1024.0),
    (POSEIDON_BUILTIN_NAME, N_STEPS_FEE_WEIGHT * 32.0),
    (SEGMENT_ARENA_BUILTIN_NAME, N_STEPS_FEE_WEIGHT * 10.0),
    (KECCAK_BUILTIN_NAME, N_STEPS_FEE_WEIGHT * 2048.0), // 2**11
];

pub(crate) const INVOKE_TX_MAX_N_STEPS: u32 = 4_000_000_u32;
pub(crate) const VALIDATE_MAX_N_STEPS: u32 = 1_000_000_u32;
