...
impl Starknet {
    ...
    pub fn call(
        ...
        let mut default_execution_resources = blockifier::execution::entry_point::ExecutionResources::default();
        let mut deprecated_execution_context = blockifier::execution::entry_point::EntryPointExecutionContext::new(
            &self.block_context,
