...
impl JsonRpcHandler {
    ...
    pub async fn get_class(&self, block_id: BlockId, class_hash: ClassHash) -> StrictRpcResult {
        match self.api.starknet.write().await.get_class(block_id.into(), class_hash) {
    ...
    pub async fn get_class_at(
        ...
        match self.api.starknet.write().await.get_class_at(block_id.into(), contract_address) {
            Ok(contract_class) => {
    ...
    pub async fn estimate_message_fee(
        ...
        match self.api.starknet.write().await.estimate_message_fee(block_id.into(), message) {
