...
use super::api::endpoints_impl::accounts::{BalanceQuery, PredeployedAccountsQuery};
...
use crate::api::models::SimulateTransactionsInput;
    ...
    fn serializing_starknet_response_empty_variant_yields_empty_json_on_conversion_to_rpc_result() {
        assert_eq!(
            ...
            serde_json::to_string(
                &StrictRpcResult::Ok(crate::api::JsonRpcResponse::Empty).to_rpc_result()
            )
            .unwrap()
        );
    }
